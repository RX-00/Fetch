...
#Class to handle serial data from the tiva C arduino and published to ROS topics
class Arduino_Class(object):
	def __init__(self):
		...
		#Publisher for the arduino's serial data
		self._SerialPublisher = rospy.Publisher('serial_arduino', String,queue_size=10)
