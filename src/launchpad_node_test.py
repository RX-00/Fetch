...
'''
'''
modified by Roy Xing, got rid of abttery timing and spd subscibers
'''
...
from SerialDataGateway import SerialDataGateway #module aids to recieve data from a serial port
from std_msgs.msg import Int16,Int32, Int64, Float32, String, Header, UInt64
#Import ROS data type for IMU
from sensor_msgs.msg import Imu

#Class to handle serial data from the tiva C launchpad and published to ROS topics
class Launchpad_Class(object):
	def __init__(self):
		...
		#Publisher for the launchpad's serial data
		self._SerialPublisher = rospy.Publisher('serial_launchpad', String,queue_size=10)
...
#Handle incoming data and calculate orientation from accelerometer and gyrometer readings
